...
use Acme\Console\Command\DayNineCommand;
use Acme\Console\Command\DayTwentyCommand;
...
$application->add(new DayNineCommand());
$application->add(new DayTwentyCommand());
